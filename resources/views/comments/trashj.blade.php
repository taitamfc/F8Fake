                            ...
                            <div class="input-group input-group-alt">
                                <div class="input-group-prepend">
                                    <button class="btn btn-secondary" type="button" data-toggle="modal"
                                        data-target="#modalFilterColumns">Tìm nâng cao
</button>
                                </div>
                        ...
                        <tbody>
                            @foreach ($comments as $comment)
                                <tr>
                                    ...
                                    <td class="align-middle"> {{ $comment->user_id }} </td>
                                    <td class="align-middle"> {{ $comment->commentstable_type }} </td>
                                    <td class="align-middle"> {{ $comment->comment }} </td>
                                    <td class="align-middle"> {{ $comment->approved }} </td>
                                    <td>
