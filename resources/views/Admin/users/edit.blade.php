                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label class="control-label" for="flatpickr01">Tên Sinh Viên</label> <input
                                    ...
                                    @endif
                                    <div class="form-group">
                                        <label class="control-label" for="flatpickr01">Tên Tài Khoản</label> <input
                                            id="flatpickr01" type="text" class="form-control" name="username"
                                            value="{{ $users->username }}" data-toggle="flatpickr">
                                    </div>
                                    @if ($errors->any())
                                    ...
                                    @endif
                                    <div class="form-group">
                                        <label class="control-label" for="flatpickr01">Bị chặn</label> <input
                                            id="flatpickr01" type="text" class="form-control" name="is_blocked"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="flatpickr01">Họ</label> <input id="flatpickr01"
                                            ...
                                            value="{{ $users->first_name }}" data-toggle="flatpickr">
                                    </div>
                                    @if ($errors->any())
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="flatpickr01">Tên</label> <input id="flatpickr01"
                                            ...
                                            value="{{ $users->last_name }}" data-toggle="flatpickr">
                                    </div>
                                    @if ($errors->any())
                                        <p style="color:red">{{ $errors->first('last_name') }}</p>
                                    @endif
                                    <div class="form-group">
                                        <label class="control-label" for="flatpickr01">Tên Đầy Đủ</label> <input
                                            id="flatpickr01" type="text" class="form-control" name="full_name"
                                            value="{{ $users->full_name }}" data-toggle="flatpickr">
                                    </div>
                                    @if ($errors->any())
                                ...
                                <div class="col-4">
                                    ...
                                    @endif
                                    <div class="form-group">
                                        <label class="control-label" for="flatpickr01">Avatar Url</label> <input
                                            id="flatpickr01" type="text" class="form-control" name="avatar_url"
                                    ...
                                    @endif
                                    <div class="form-group">
                                        <label class="control-label" for="flatpickr01">Cover Url</label> <input
                                            id="flatpickr01" type="text" class="form-control" name="cover_url"
