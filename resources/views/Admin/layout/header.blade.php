      ...
      <div class="top-bar-list">
                  ...
                  <div class="list-group list-group-flush list-group-reflow mb-2">
                    ...
                    <div class="list-group-item py-2">
                      ...
                      <div class="user-avatar user-avatar-sm bg-muted">
                        <img src="{{ asset('AdminTheme/assets/images/avatars/bootstrap.svg')}}" alt="">
                      </div>
                      <div class="ml-2">
                    ...
                    <div class="list-group-item py-2">
                      <a href="#" class="stretched-link"><span class="sr-only">Go to search result</span></a>
                      <div class="user-avatar user-avatar-sm bg-muted">
                        <img src="{{ asset('AdminTheme/assets/images/avatars/slack.svg')}}" alt="">
                      </div>
                      <div class="ml-2">
        ...
        <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
                ...
                <div class="dropdown-scroll perfect-scrollbar">
                  ...
                  <a href="#" class="dropdown-item unread">
                    <div class="user-avatar">
                      <img src="{{ asset('AdminTheme/assets/images/avatars/uifaces15.jpg')}}" alt="">
                    </div>
                  ...
                  <a href="#" class="dropdown-item unread">
                    <div class="user-avatar">
                      <img src="{{ asset('AdminTheme/assets/images/avatars/uifaces16.jpg')}}" alt="">
                    </div>
                    <div class="dropdown-item-body">
                  ...
                  <a href="#" class="dropdown-item">
                    <div class="user-avatar">
                      <img src="{{ asset('AdminTheme/assets/images/avatars/uifaces17.jpg')}}" alt="">
                    </div>
                    <div class="dropdown-item-body">
                  ...
                  <a href="#" class="dropdown-item">
                    <div class="user-avatar">
                      <img src="{{ asset('AdminTheme/assets/images/avatars/uifaces18.jpg')}}" alt="">
                    </div>
                    <div class="dropdown-item-body">
                  ...
                  <a href="#" class="dropdown-item">
                    <div class="user-avatar">
                      <img src="{{ asset('AdminTheme/assets/images/avatars/uifaces19.jpg')}}" alt="">
                    </div>
                    <div class="dropdown-item-body">
                  ...
                  <a href="#" class="dropdown-item">
                    <div class="user-avatar">
                      <img src="{{ asset('AdminTheme/assets/images/avatars/uifaces20.jpg')}}" alt="">
                    </div>
                    <div class="dropdown-item-body">
                  ...
                  <a href="#" class="dropdown-item">
                    <div class="user-avatar">
                      <img src="{{ asset('AdminTheme/assets/images/avatars/uifaces21.jpg')}}" alt="">
                    </div>
                    <div class="dropdown-item-body">
            ...
            <li class="nav-item dropdown header-nav-dropdown has-notified">
              ...
              <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                ...
                <div class="dropdown-scroll perfect-scrollbar">
                  ...
                  <a href="#" class="dropdown-item unread">
                    <div class="user-avatar">
                      <img src="{{ asset('AdminTheme/assets/images/avatars/team1.jpg')}}" alt="">
                    </div>
                    <div class="dropdown-item-body">
                  ...
                  <a href="#" class="dropdown-item">
                    <div class="user-avatar">
                      <img src="{{ asset('AdminTheme/assets/images/avatars/team3.png')}}" alt="">
                    </div>
                    <div class="dropdown-item-body">
                  ...
                  <a href="#" class="dropdown-item">
                    <div class="user-avatar">
                      <img src="{{ asset('AdminTheme/assets/images/avatars/team2.png')}}" alt="">
                    </div>
                    <div class="dropdown-item-body">
          ...
          <div class="dropdown d-none d-md-flex">
            <button class="btn-account" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-md"><img src="{{ asset(auth()->user()->avatar)}}" alt=""></span> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">{{auth()->user()->name}}</span> <span class="account-description">{{auth()->user()->group->name}}</span></span></button> <!-- .dropdown-menu -->
            <div class="dropdown-menu">
              <div class="dropdown-arrow d-lg-none" x-arrow=""></div>
              <div class="dropdown-arrow ml-3 d-none d-lg-block"></div>
              <h6 class="dropdown-header d-none d-md-block d-lg-none"> </h6><a class="dropdown-item" href="user-profile.html"><span class="dropdown-icon oi oi-person"></span> Profile</a> <a class="dropdown-item" href="{{route('logout')}}"><span class="dropdown-icon oi oi-account-logout"></span> Logout</a>
