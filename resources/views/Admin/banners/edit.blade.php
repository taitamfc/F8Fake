                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('banners.update', $banners->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control"  id="ckeditor1" rows="5"
                                style="resize: none">{{ old('description') ?? $banners->description }}</textarea>
                            {{-- <small class="form-text text-muted"></small> --}}
                            @if ($errors->any())
