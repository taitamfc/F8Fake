...
<html lang="en">
  <head>
    ...
    <!-- Begin SEO tag -->
    <title> Sign In | Looper - Bootstrap 4 AdminTheme Theme </title>
    <meta property="og:title" content="Sign In">
    <meta name="author" content="Beni Arisandi">
    <meta property="og:locale" content="en_US">
    <meta name="description" content="Responsive adminTheme theme build on top of Bootstrap 4">
    <meta property="og:description" content="Responsive adminTheme theme build on top of Bootstrap 4">
    <link rel="canonical" href="https://uselooper.com">
    <meta property="og:url" content="https://uselooper.com">
    <meta property="og:site_name" content="Looper - Bootstrap 4 AdminTheme Theme">
    <script type="application/ld+json">
      {
        "name": "Looper - Bootstrap 4 AdminTheme Theme",
        "description": "Responsive adminTheme theme build on top of Bootstrap 4",
        "author":
        {
          "@type": "Person",
          "name": "Beni Arisandi"
    ...
    <link rel="stylesheet" href="{{asset('AdminTheme/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css ')}}"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
  ...
  <body>
    ...
    <main class="auth">
      <header id="auth-header" class="auth-header" style="background-image: url(assets/images/illustration/img-1.png);">
        ...
        {{-- <p> Không có tài khoản?  <a href="">Tạo Tài Khoản</a> --}}
        </p>
      </header><!-- form -->
      <form class="auth-form" action="{{route('loginProcessing')}}" method="POST">
        <!-- .form-group -->
        @csrf
        <div class="form-group">
          <div class="form-label-group">
            <input type="text" id="inputUser" class="form-control" name="email"  autofocus=""> <label for="inputUser">Email</label>
          </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
          <div class="form-label-group">
            <input type="password" id="inputPassword" class="form-control" name="password" > <label for="inputPassword">Mật Khẩu</label>
          </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
        ...
        <div class="form-group text-center">
          <div class="custom-control custom-control-inline custom-checkbox">
            <input type="checkbox" class="custom-control-input" id="remember-me"> <label class="custom-control-label" for="remember-me">Nhớ Mật Khẩu</label>
          </div>
        </div><!-- /.form-group -->
        <!-- recovery links -->
    ...
    <!-- BEGIN PLUGINS JS -->
    <script src="{{asset('AdminTheme/assets/vendor/particles.js/particles.js')}}"></script>
    <script>
      /**
    ...
    <!-- BEGIN THEME JS -->
    <script src="{{asset('AdminTheme/assets/javascript/theme.js')}}"></script> <!-- END THEME JS -->
